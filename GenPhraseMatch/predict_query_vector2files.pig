...
Query = foreach QueryInput generate (chararray)$0 as (query:chararray), ( $1 is not null ? (chararray)$1 : '' ) as phrase:chararray ;
Query1 = foreach Query generate query ;
Query2 = foreach Query generate phrase ;
