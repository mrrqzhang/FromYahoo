...
#featurefile=gbdtFeatureDump-for-qlas-10kqry.txt
#featurefile=gbdtFeatureDump-qlaslm.txt
#featurefile=gbdtFeatureDump6-qlas-newrbo.txt
featurefile=gbdtFeatureDump8-qlas-newrbo.txt
# featurefile=gbdtFeatureDump7-qlas.txt

#rbosource=train-rbo-value.txt
