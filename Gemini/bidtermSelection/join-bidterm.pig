...
Q = foreach Q generate  (chararray)$1 as r:chararray ;
Q = distinct Q ;
...
C =  foreach (cogroup Q by r inner, B by b inner) generate flatten(B) as (b:chararray, adv:chararray, adgroup:chararray) ;
